...
#Здесь могу честно признаться, что не догадалась как реализовать структуру,
#также не поняла как работает Ваш код.
#Двухчасовое чтение теорий про стеки и повторный просмотр этого момента на уроке не помогли.
